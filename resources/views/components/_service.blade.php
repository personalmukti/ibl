            ...
            <div class="justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="row py-5">
                        ...
                        <div class="col-md-2">
                            <a class="card-link" href="{{ route('homepage.service') }}">
                                <div class="card animate__animated animate__slideInRight service-card">
                            ...
                            <a class="card-link" href="{{ route('homepage.service') }}">
                                <div class="card animate__animated animate__slideInRight service-card">
                                    <div class="card-body feature-card-body">
                                        <div class="row">
                                            <div class="col-12 d-flex flex-column align-items-center text-center">
                                                <span class="features-icon"><i
                                                        class="fa-solid fa-truck-fast fa-3x"></i></span>
                                                <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-12 d-flex flex-column align-items-center text-center">
                                                <span class="features-icon"><i class="fa fa-cubes fa-3x"
                                                        aria-hidden="true"></i></span>
                                                <hr>
                                                <p class="feature-name">Reefer Service</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
