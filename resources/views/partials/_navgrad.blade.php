<nav class="navbar navbar-expand-md navbar-dark fixed-top glass-nav" style="max-width: 100%;">
    <div class="container-fluid">
        ...
        <div class="d-none d-md-flex flex-column align-items-md-start ms-2">
            <span class="navbar-text" style="font-weight: bold; text-transform: uppercase; color: black;">PT. Interbenua
                Logistindo</span>
            <span class="navbar-text" style="font-style: italic; font-size: smaller; color: black;">Member of IFF
